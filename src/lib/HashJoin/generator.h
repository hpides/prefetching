 ...
 */
int create_relation_nonunique(relation_t *reln, int32_t ntuples, const int32_t maxid, NumaAllocator *numa_alloc);

/**
 * Create relation with only primary keys (i.e. keys are unique from 1 to
 * num_tuples)
 */
int create_relation_pk(relation_t *reln, int32_t ntuples, NumaAllocator *numa_alloc);
 ...
 */
int create_relation_fk(relation_t *reln, int32_t ntuples, const int32_t maxid, NumaAllocator *numa_alloc);
 ...
 */
int create_relation_fk_from_pk(relation_t *fkrel, relation_t *pkrel, int32_t ntuples, NumaAllocator *numa_alloc);
 ...
 */
int create_relation_zipf(relation_t *reln, int32_t ntuples,
                         const int32_t maxid, const double zipfparam, NumaAllocator *numa_alloc);
 ...
 */
int parallel_create_relation_pk(relation_t *reln, int32_t ntuples,
 ...
 * nthreads in parallel, where each memory is initialized thread local.
 */
int parallel_create_relation_fk(relation_t *reln, int32_t ntuples,
                                const int32_t maxid, uint32_t nthreads, NumaAllocator *numa_alloc);
 ...
 */
void delete_relation(relation_t *reln, NumaAllocator *numa_alloc);
